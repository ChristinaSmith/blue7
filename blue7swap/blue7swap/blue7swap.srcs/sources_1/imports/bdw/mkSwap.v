...
//
// On Tue Sep 18 14:30:47 EDT 2012
//
...
module mkSwap(CLK,
  ...
  reg [1 : 0] CASE_firstFD_OUT_BITS_9_TO_8_3_0_firstFD_OUT_ETC__q4,
	      ...
	      CASE_thirdFD_OUT_BITS_9_TO_8_3_0_thirdFD_OUT_ETC__q3;
  wire IF_count_ULT_6_THEN_firstF_i_notFull_ELSE_IF_c_ETC___d9,
       count_ULT_12___d106,
       count_ULT_6___d119;
  ...
  assign CAN_FIRE_RL_advance =
	     inF$EMPTY_N &&
	     IF_count_ULT_6_THEN_firstF_i_notFull_ELSE_IF_c_ETC___d9 ;
  ...
  assign MUX_flag$write_1__SEL_1 =
	     WILL_FIRE_RL_advanceOutputPayload && thirdF$D_OUT[9:8] != 2'd0 ;
  assign MUX_outF$enq_1__VAL_1 =
	     { CASE_secondFD_OUT_BITS_9_TO_8_3_0_secondFD_O_ETC__q2,
	       secondF$D_OUT[7:0] } ;
  assign MUX_outF$enq_1__VAL_2 =
	     { CASE_firstFD_OUT_BITS_9_TO_8_3_0_firstFD_OUT_ETC__q4,
	       firstF$D_OUT[7:0] } ;
  ...
  assign firstF$D_IN =
	     { CASE_inFD_OUT_BITS_9_TO_8_3_0_inFD_OUT_BITS__ETC__q5,
	       inF$D_OUT[7:0] } ;
  assign firstF$ENQ = WILL_FIRE_RL_advance && count_ULT_6___d119 ;
  ...
  assign secondF$ENQ =
	     WILL_FIRE_RL_advance && !count_ULT_6___d119 &&
	     count_ULT_12___d106 ;
  ...
  // remaining internal signals
  assign IF_count_ULT_6_THEN_firstF_i_notFull_ELSE_IF_c_ETC___d9 =
	     count_ULT_6___d119 ?
	       firstF$FULL_N :
	       (count_ULT_12___d106 ? secondF$FULL_N : thirdF$FULL_N) ;
  assign count_ULT_12___d106 = count < 8'd12 ;
  assign count_ULT_6___d119 = count < 8'd6 ;
  always@(outF$D_OUT)
  begin
    case (outF$D_OUT[9:8])
      2'd0, 2'd1, 2'd2:
  ...
  begin
    case (thirdF$D_OUT[9:8])
	  ...
	  CASE_thirdFD_OUT_BITS_9_TO_8_3_0_thirdFD_OUT_ETC__q3 =
	      thirdF$D_OUT[9:8];
      2'd3: CASE_thirdFD_OUT_BITS_9_TO_8_3_0_thirdFD_OUT_ETC__q3 = 2'd3;
    endcase
  end
  always@(firstF$D_OUT)
  begin
    case (firstF$D_OUT[9:8])
	  ...
	  CASE_firstFD_OUT_BITS_9_TO_8_3_0_firstFD_OUT_ETC__q4 =
	      firstF$D_OUT[9:8];
      2'd3: CASE_firstFD_OUT_BITS_9_TO_8_3_0_firstFD_OUT_ETC__q4 = 2'd3;
    endcase
  end
  always@(inF$D_OUT)
  begin
