...
//
// On Tue Sep 18 11:55:22 EDT 2012
//
...
module mkFTop_kc705(sys0_clkp,
  ...
  // ports of submodule swap
  wire [9 : 0] swap$in_put, swap$out_get;
  wire swap$EN_in_put, swap$EN_out_get, swap$RDY_in_put, swap$RDY_out_get;
  ...
  reg [1 : 0] CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3,
	      CASE_swapout_get_BITS_9_TO_8_3_0_swapout_get_ETC__q1;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q2,
		 _643371375338640__q4,
		 bs__h15524,
		 bs__h2999;
  wire [15 : 0] x_data__h18722;
  wire [2 : 0] d0__h2625,
	       d10__h2615,
	       d11__h2614,
	       d12__h2613,
  ...
  // submodule swap
  mkSwap swap(.CLK(sys1_clk$O),
	      .RST_N(sys1_rst$OUT_RST_N),
	      .in_put(swap$in_put),
	      .EN_in_put(swap$EN_in_put),
	      .EN_out_get(swap$EN_out_get),
	      .RDY_in_put(swap$RDY_in_put),
	      .out_get(swap$out_get),
	      .RDY_out_get(swap$RDY_out_get));
  ...
  assign CAN_FIRE_RL_mkConnectionGetPut =
	     gmac$RDY_tx_put && swap$RDY_out_get ;
  assign WILL_FIRE_RL_mkConnectionGetPut = CAN_FIRE_RL_mkConnectionGetPut ;

  // rule RL_mkConnectionGetPut_1
  assign CAN_FIRE_RL_mkConnectionGetPut_1 =
	     gmac$RDY_rx_get && swap$RDY_in_put ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h2999[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDD$EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h15524[mdi_rPlayIndex$Q_OUT] ;
  ...
  assign mdi_vrReadData$EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex$Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q4[mdi_rPlayIndex$Q_OUT] ;
  ...
  assign gmac$tx_put =
	     { CASE_swapout_get_BITS_9_TO_8_3_0_swapout_get_ETC__q1,
	       swap$out_get[7:0] } ;
  assign gmac$EN_rx_get = CAN_FIRE_RL_mkConnectionGetPut_1 ;
  assign gmac$EN_tx_put = CAN_FIRE_RL_mkConnectionGetPut ;
  assign gmac$EN_rxOperate = 1'd1 ;
  assign gmac$EN_txOperate = 1'd1 ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h18722 } ;
  ...
  // submodule swap
  assign swap$in_put =
	     { CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3,
	       gmac$rx_get[7:0] } ;
  assign swap$EN_in_put = CAN_FIRE_RL_mkConnectionGetPut_1 ;
  assign swap$EN_out_get = CAN_FIRE_RL_mkConnectionGetPut ;

  // remaining internal signals
  assign _1434766110945527031733894725304609466537681244_ETC__q2 =
	     195'h2492492492492492492492492492492492492492492492492 ;
  assign _643371375338640__q4 =
  ...
  assign bs__h2999 =
		 ...
		 108'hFFFFFFFFFFFFFFFFFFFFFFFF1F8,
	       ...
	       d0__h2625,
	       3'b111 } ;
  assign d0__h2625 = {3{mdi_rWriteData[0]}} ;
  assign d10__h2615 = {3{mdi_rWriteData[10]}} ;
  assign d11__h2614 = {3{mdi_rWriteData[11]}} ;
  assign d12__h2613 = {3{mdi_rWriteData[12]}} ;
  assign d13__h2612 = {3{mdi_rWriteData[13]}} ;
  assign d14__h2611 = {3{mdi_rWriteData[14]}} ;
  assign d15__h2610 = {3{mdi_rWriteData[15]}} ;
  assign d1__h2624 = {3{mdi_rWriteData[1]}} ;
  assign d2__h2623 = {3{mdi_rWriteData[2]}} ;
  assign d3__h2622 = {3{mdi_rWriteData[3]}} ;
  assign d4__h2621 = {3{mdi_rWriteData[4]}} ;
  assign d5__h2620 = {3{mdi_rWriteData[5]}} ;
  assign d6__h2619 = {3{mdi_rWriteData[6]}} ;
  assign d7__h2618 = {3{mdi_rWriteData[7]}} ;
  assign d8__h2617 = {3{mdi_rWriteData[8]}} ;
  assign d9__h2616 = {3{mdi_rWriteData[9]}} ;
  assign pa0__h2602 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h2601 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h2600 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h2599 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h2598 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h2608 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h2607 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h2606 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h2605 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h2604 = {3{mdi_rRegAddr[4]}} ;
  assign x_data__h18722 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  always@(swap$out_get)
  begin
    case (swap$out_get[9:8])
      2'd0, 2'd1, 2'd2:
	  CASE_swapout_get_BITS_9_TO_8_3_0_swapout_get_ETC__q1 =
	      swap$out_get[9:8];
      2'd3: CASE_swapout_get_BITS_9_TO_8_3_0_swapout_get_ETC__q1 = 2'd3;
    endcase
  end
  always@(gmac$rx_get)
  begin
    case (gmac$rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3 =
	      gmac$rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3 = 2'd3;
    endcase
  end
