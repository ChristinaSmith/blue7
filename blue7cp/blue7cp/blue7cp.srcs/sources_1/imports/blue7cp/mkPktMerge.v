...
// Method: iport0_put
// Conflict-free: iport1_put, oport_get
// Conflicts: iport0_put
//
// Method: iport1_put
// Conflict-free: iport0_put, oport_get
// Conflicts: iport1_put
//
// Method: oport_get
// Conflict-free: iport0_put, iport1_put
// Conflicts: oport_get
//
//
// Ports:
...
module mkPktMerge(CLK,
  ...
  // submodule fi0
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fi0(.RST_N(RST_N),
						.CLK(CLK),
						.D_IN(fi0$D_IN),
						.ENQ(fi0$ENQ),
						.DEQ(fi0$DEQ),
  ...
  // submodule fi1
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fi1(.RST_N(RST_N),
						.CLK(CLK),
						.D_IN(fi1$D_IN),
						.ENQ(fi1$ENQ),
						.DEQ(fi1$DEQ),
  ...
  // submodule fo
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fo(.RST_N(RST_N),
					       .CLK(CLK),
					       .D_IN(fo$D_IN),
					       .ENQ(fo$ENQ),
					       .DEQ(fo$DEQ),
  ...
  // rule RL_fi1_advance
  assign CAN_FIRE_RL_fi1_advance = fo$FULL_N && fi1$EMPTY_N && !fi0Active ;
