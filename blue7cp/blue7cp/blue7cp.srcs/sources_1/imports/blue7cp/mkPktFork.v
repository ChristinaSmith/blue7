...
// Method: iport_put
// Conflict-free: oport0_get, oport1_get
// Conflicts: iport_put
//
// Method: oport0_get
// Conflict-free: iport_put, oport1_get
// Conflicts: oport0_get
//
// Method: oport1_get
// Conflict-free: iport_put, oport0_get
// Conflicts: oport1_get
//
//
// Ports:
// Name                         I/O  size props
...
module mkPktFork(pfk,
  ...
  reg IF_pfk_BITS_13_TO_12_3_EQ_0_4_THEN_fi_first_BI_ETC___d58;
  ...
  // submodule fi
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fi(.RST_N(RST_N),
					       .CLK(CLK),
					       .D_IN(fi$D_IN),
					       .ENQ(fi$ENQ),
					       .DEQ(fi$DEQ),
  ...
  // submodule fo0
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fo0(.RST_N(RST_N),
						.CLK(CLK),
						.D_IN(fo0$D_IN),
						.ENQ(fo0$ENQ),
						.DEQ(fo0$DEQ),
  ...
  // submodule fo1
  FIFO2 #(.width(32'd153), .guarded(32'd1)) fo1(.RST_N(RST_N),
						.CLK(CLK),
						.D_IN(fo1$D_IN),
						.ENQ(fo1$ENQ),
						.DEQ(fo1$DEQ),
  ...
  assign MUX_f0Active$write_1__SEL_1 =
	     WILL_FIRE_RL_select &&
	     IF_pfk_BITS_13_TO_12_3_EQ_0_4_THEN_fi_first_BI_ETC___d58 ;
