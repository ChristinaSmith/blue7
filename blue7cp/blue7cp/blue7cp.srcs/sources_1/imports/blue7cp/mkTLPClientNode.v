...
//
// On Thu Sep 20 15:16:37 EDT 2012
//
// Method conflict info:
// Method: s_request_put
// Conflict-free: s_response_get, p_put, g_get
// Conflicts: s_request_put
//
// Method: s_response_get
// Conflict-free: s_request_put, p_put, g_get
// Conflicts: s_response_get
//
// Method: p_put
// Conflict-free: s_request_put, s_response_get, g_get
// Conflicts: p_put
//
// Method: g_get
// Conflict-free: s_request_put, s_response_get, p_put
// Conflicts: g_get
//
//
// Ports:
...
module mkTLPClientNode(pfk,
  ...
  wire [152 : 0] g_get, s_response_get;
  wire RDY_g_get, RDY_p_put, RDY_s_request_put, RDY_s_response_get;
  ...
  wire [13 : 0] IF_pfk_BITS_13_TO_12_EQ_0_OR_pfk_BITS_13_TO_12_ETC___d15;

  // action method s_request_put
  assign RDY_s_request_put = pktMerge$RDY_iport0_put ;
  assign CAN_FIRE_s_request_put = pktMerge$RDY_iport0_put ;
  assign WILL_FIRE_s_request_put = EN_s_request_put ;

  // actionvalue method s_response_get
  assign s_response_get = pktFork$oport0_get ;
  assign RDY_s_response_get = pktFork$RDY_oport0_get ;
  assign CAN_FIRE_s_response_get = pktFork$RDY_oport0_get ;
  ...
  // submodule pktFork
  mkPktFork pktFork(.pfk(IF_pfk_BITS_13_TO_12_EQ_0_OR_pfk_BITS_13_TO_12_ETC___d15),
		    .CLK(CLK),
		    .RST_N(RST_N),
  ...
  assign pktFork$EN_oport0_get = EN_s_response_get ;
  assign pktFork$EN_oport1_get = CAN_FIRE_RL_mkConnectionGetPut ;

  // submodule pktMerge
  assign pktMerge$iport0_put = s_request_put ;
  assign pktMerge$iport1_put = pktFork$oport1_get ;
  assign pktMerge$EN_iport0_put = EN_s_request_put ;
  assign pktMerge$EN_iport1_put = CAN_FIRE_RL_mkConnectionGetPut ;
  assign pktMerge$EN_oport_get = EN_g_get ;

  // remaining internal signals
  assign IF_pfk_BITS_13_TO_12_EQ_0_OR_pfk_BITS_13_TO_12_ETC___d15 =
