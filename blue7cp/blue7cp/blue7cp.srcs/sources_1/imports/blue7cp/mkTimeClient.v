...
//
// On Thu Sep 20 15:16:20 EDT 2012
//
// Method conflict info:
// Method: gpsTime
// Conflict-free: wti_m_get, wti_m_sThreadBusy, wti_m_sReset_n
// Conflicts: gpsTime
//
// Method: wti_m_get
// Conflict-free: gpsTime, wti_m_get, wti_m_sThreadBusy, wti_m_sReset_n
//
// Method: wti_m_sThreadBusy
// Conflict-free: gpsTime, wti_m_get, wti_m_sReset_n
// Conflicts: wti_m_sThreadBusy
//
// Method: wti_m_sReset_n
// Conflict-free: gpsTime, wti_m_get, wti_m_sThreadBusy
// Sequenced before (restricted): wti_m_sReset_n
//
//
// Ports:
// Name                         I/O  size props
...
module mkTimeClient(CLK_sys0_clk,
  ...
  wire CAN_FIRE_RL_send_time,
       CAN_FIRE_RL_wti_peerIsReady__dreg_update,
       CAN_FIRE_RL_wti_sThreadBusy_reg,
       CAN_FIRE_gpsTime,
       CAN_FIRE_wti_m_sReset_n,
       CAN_FIRE_wti_m_sThreadBusy,
       WILL_FIRE_RL_send_time,
       WILL_FIRE_RL_wti_peerIsReady__dreg_update,
       WILL_FIRE_RL_wti_sThreadBusy_reg,
       WILL_FIRE_gpsTime,
       WILL_FIRE_wti_m_sReset_n,
       WILL_FIRE_wti_m_sThreadBusy;

  // action method gpsTime
  assign RDY_gpsTime = now$sRDY ;
  assign CAN_FIRE_gpsTime = now$sRDY ;
  assign WILL_FIRE_gpsTime = EN_gpsTime ;

  // value method wti_m_get
  assign wti_m_req = wti_sThreadBusy_d ? 67'h0AAAAAAAAAAAAAAAA : wti_nowReq ;

  // action method wti_m_sThreadBusy
  assign CAN_FIRE_wti_m_sThreadBusy = 1'd1 ;
  assign WILL_FIRE_wti_m_sThreadBusy = wti_m_SThreadBusy ;

  // action method wti_m_sReset_n
  assign CAN_FIRE_wti_m_sReset_n = 1'd1 ;
  assign WILL_FIRE_wti_m_sReset_n = wti_m_SReset_n ;
  ...
  // rule RL_send_time
  assign CAN_FIRE_RL_send_time = 1'd1 ;
  assign WILL_FIRE_RL_send_time = 1'd1 ;

  // rule RL_wti_sThreadBusy_reg
  assign CAN_FIRE_RL_wti_sThreadBusy_reg = 1'd1 ;
  assign WILL_FIRE_RL_wti_sThreadBusy_reg = 1'd1 ;

  // rule RL_wti_peerIsReady__dreg_update
  assign CAN_FIRE_RL_wti_peerIsReady__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_wti_peerIsReady__dreg_update = 1'd1 ;
