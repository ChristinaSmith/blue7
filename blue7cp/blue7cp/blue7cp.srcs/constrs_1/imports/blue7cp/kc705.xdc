...
set_false_path -from [get_pins ftop/sys0_rst/reset_hold_reg[15]/C] -to [get_pins ftop/sys1_rst/reset_hold_reg[0]/CLR] -setup
set_false_path -from [get_clocks GMII_GTX_CLK] -to [get_clocks sys0_clkp] -setup