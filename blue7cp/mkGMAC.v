...
//
// On Fri Sep 21 11:05:11 EDT 2012
//
...
module mkGMAC(CLK_rxClk,
  ...
  wire rxRS_preambleCnt_incAction$whas,
  ...
  assign CAN_FIRE_rx_get = rxRS_rxF$dEMPTY_N ;
  assign WILL_FIRE_rx_get = EN_rx_get ;

  // action method tx_put
  assign RDY_tx_put = txRS_txF$sFULL_N ;
  assign CAN_FIRE_tx_put = txRS_txF$sFULL_N ;
  ...
  assign CAN_FIRE_RL_rxRS_overflow_detect = rxRS_rxOperateS$dD_OUT ;
  assign WILL_FIRE_RL_rxRS_overflow_detect = rxRS_rxOperateS$dD_OUT ;
  ...
  // rule RL_rxRS_dv_reg
  assign CAN_FIRE_RL_rxRS_dv_reg = rxRS_rxOperateS$dD_OUT ;
  assign WILL_FIRE_RL_rxRS_dv_reg = rxRS_rxOperateS$dD_OUT ;
  ...
  assign CAN_FIRE_RL_txRS_undeflow_detect = txRS_txOperateS$dD_OUT ;
  assign WILL_FIRE_RL_txRS_undeflow_detect = txRS_txOperateS$dD_OUT ;
  ...
  assign CAN_FIRE_RL_txRS_egress_EOF =
	     txRS_txF$dEMPTY_N &&
	     (txRS_lenCnt_value_45_ULT_59___d296 || txRS_txF$dEMPTY_N) &&
	     txRS_txOperateS$dD_OUT &&
	     txRS_txActive &&
  ...
  assign CAN_FIRE_RL_txRS_lenCnt_ruleInc = txRS_lenCnt_incAction$whas ;
  ...
  assign CAN_FIRE_RL_txRS_crcDbgCnt_ruleInc = txRS_crcDbgCnt_incAction$whas ;
  ...
  assign MUX_txRS_emitFCS$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     !txRS_lenCnt_value_45_ULT_59___d296 ;
  ...
  assign rxRS_rxPipe$EN = CAN_FIRE_RL_rxRS_ingress_advance ;
  ...
  // register txRS_doPad
  assign txRS_doPad$D_IN = txRS_lenCnt_value_45_ULT_59___d296 ;
  ...
  assign rxRS_crc$EN_add = CAN_FIRE_RL_rxRS_crc_capture ;
  assign rxRS_crc$EN_clear = 1'b0 ;
  assign rxRS_crc$EN_complete = CAN_FIRE_RL_rxRS_ingress_noadvance ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_45_ULT_59___d296 = txRS_lenCnt_value < 12'd59 ;
  assign txRS_preambleCnt_value_19_ULT_7___d297 =
	     txRS_preambleCnt_value < 5'd7 ;
