...
//
// On Fri Sep 21 11:05:15 EDT 2012
//
...
module mkEDCPAdapter(CLK,
  ...
  // inlined wires
  wire eDoReq_1$wget, edpFsm_start_wire$whas, edpFsm_state_set_pw$whas;
  ...
  wire CAN_FIRE_RL_cp_to_dcp_response,
       CAN_FIRE_RL_dcp_to_cp_request,
       CAN_FIRE_RL_eDoReq__dreg_update,
       CAN_FIRE_RL_ecp_egress,
       CAN_FIRE_RL_ecp_ingress,
       CAN_FIRE_RL_edpFsm_action_l222c14,
       CAN_FIRE_RL_edpFsm_action_l223c14,
       CAN_FIRE_RL_edpFsm_action_l224c14,
       CAN_FIRE_RL_edpFsm_action_l225c14,
       CAN_FIRE_RL_edpFsm_action_l227c16,
       CAN_FIRE_RL_edpFsm_action_l229c16,
       CAN_FIRE_RL_edpFsm_action_l230c16,
       CAN_FIRE_RL_edpFsm_fsm_start,
       CAN_FIRE_RL_edpFsm_idle_l221c3,
       CAN_FIRE_RL_edpFsm_idle_l221c3_1,
       CAN_FIRE_RL_edpFsm_restart,
       CAN_FIRE_RL_edpFsm_start_reg_1__dreg_update,
       CAN_FIRE_RL_edpFsm_state_every,
       CAN_FIRE_RL_edpFsm_state_fired__dreg_update,
       CAN_FIRE_RL_edpFsm_state_handle_abort,
       CAN_FIRE_RL_rx_ecp_dcp,
       ...
       WILL_FIRE_RL_eDoReq__dreg_update,
       ...
       WILL_FIRE_RL_edpFsm_idle_l221c3,
       WILL_FIRE_RL_edpFsm_idle_l221c3_1,
       WILL_FIRE_RL_edpFsm_restart,
       WILL_FIRE_RL_edpFsm_start_reg_1__dreg_update,
       WILL_FIRE_RL_edpFsm_state_every,
       WILL_FIRE_RL_edpFsm_state_fired__dreg_update,
       WILL_FIRE_RL_edpFsm_state_handle_abort,
       WILL_FIRE_RL_rx_ecp_dcp,
  ...
  wire [47 : 0] x__h3330, x__h5061, x__h5102, x__h5157, y__h5123, y__h5168;
  wire [31 : 0] bedw__h1824;
  wire [15 : 0] x__h5190, x__h5258;
  wire [7 : 0] IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d450;
  wire [3 : 0] x__h1849;
  wire IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15__ETC___d146,
       IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17__ETC___d144,
       dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440,
       dcpReqF_first__13_BITS_71_TO_64_31_EQ_IF_lastT_ETC___d438,
       dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15_OR__ETC___d149,
       dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17_AND_ETC___d190,
       edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247;

  // action method server_request_put
  assign RDY_server_request_put = ecpReqF$FULL_N ;
  assign CAN_FIRE_server_request_put = ecpReqF$FULL_N ;
  ...
  assign CAN_FIRE_server_response_get = ecpRespF$EMPTY_N ;
  ...
  // rule RL_ecp_ingress
  assign CAN_FIRE_RL_ecp_ingress = ecpReqF$EMPTY_N && !eDoReq ;
  assign WILL_FIRE_RL_ecp_ingress = CAN_FIRE_RL_ecp_ingress ;

  // rule RL_edpFsm_action_l223c14
  assign CAN_FIRE_RL_edpFsm_action_l223c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd1 ;
  assign WILL_FIRE_RL_edpFsm_action_l223c14 =
	     CAN_FIRE_RL_edpFsm_action_l223c14 ;

  // rule RL_edpFsm_action_l224c14
  assign CAN_FIRE_RL_edpFsm_action_l224c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd2 ;
  assign WILL_FIRE_RL_edpFsm_action_l224c14 =
	     CAN_FIRE_RL_edpFsm_action_l224c14 ;

  // rule RL_rx_ecp_dcp
  assign CAN_FIRE_RL_rx_ecp_dcp =
	     eMAddrF$FULL_N &&
	     CASE_eDMH_BITS_13_TO_12_NOT_eDMH_BITS_13_TO_12_ETC__q5 &&
	     eDoReq ;
  assign WILL_FIRE_RL_rx_ecp_dcp = CAN_FIRE_RL_rx_ecp_dcp ;

  // rule RL_dcp_to_cp_request
  assign CAN_FIRE_RL_dcp_to_cp_request =
	     dcpReqF$EMPTY_N &&
	     IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15__ETC___d146 ;
  assign WILL_FIRE_RL_dcp_to_cp_request = CAN_FIRE_RL_dcp_to_cp_request ;

  // rule RL_cp_to_dcp_response
  assign CAN_FIRE_RL_cp_to_dcp_response = dcpRespF$FULL_N && cpRespF$EMPTY_N ;
  assign WILL_FIRE_RL_cp_to_dcp_response =
	     CAN_FIRE_RL_cp_to_dcp_response &&
	     !WILL_FIRE_RL_dcp_to_cp_request ;

  // rule RL_eDoReq__dreg_update
  assign CAN_FIRE_RL_eDoReq__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_eDoReq__dreg_update = 1'd1 ;

  // rule RL_edpFsm_restart
  assign CAN_FIRE_RL_edpFsm_restart =
	     edpFsm_start_reg_1 && !edpFsm_state_fired ;
  assign WILL_FIRE_RL_edpFsm_restart = CAN_FIRE_RL_edpFsm_restart ;

  // rule RL_edpFsm_action_l225c14
  assign CAN_FIRE_RL_edpFsm_action_l225c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd3 ;
  assign WILL_FIRE_RL_edpFsm_action_l225c14 =
	     CAN_FIRE_RL_edpFsm_action_l225c14 ;

  // rule RL_edpFsm_action_l227c16
  assign CAN_FIRE_RL_edpFsm_action_l227c16 =
  ...
  assign CAN_FIRE_RL_edpFsm_action_l229c16 =
  ...
  assign CAN_FIRE_RL_edpFsm_action_l230c16 =
  ...
  assign CAN_FIRE_RL_edpFsm_fsm_start =
	     edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247 &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) &&
	     edpFsm_start_reg ;
  assign WILL_FIRE_RL_edpFsm_fsm_start = CAN_FIRE_RL_edpFsm_fsm_start ;

  // rule RL_edpFsm_action_l222c14
  assign CAN_FIRE_RL_edpFsm_action_l222c14 =
  ...
  // rule RL_ecp_egress
  assign CAN_FIRE_RL_ecp_egress =
	     edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247 &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) &&
	     !edpFsm_start_reg &&
	     eMAddrF$EMPTY_N &&
	     dcpRespF$EMPTY_N ;
  assign WILL_FIRE_RL_ecp_egress = CAN_FIRE_RL_ecp_egress ;

  // rule RL_edpFsm_idle_l221c3
  assign CAN_FIRE_RL_edpFsm_idle_l221c3 =
	     !edpFsm_start_wire$whas && edpFsm_state_mkFSMstate == 4'd5 ;
  assign WILL_FIRE_RL_edpFsm_idle_l221c3 = CAN_FIRE_RL_edpFsm_idle_l221c3 ;

  // rule RL_edpFsm_idle_l221c3_1
  assign CAN_FIRE_RL_edpFsm_idle_l221c3_1 =
	     !edpFsm_start_wire$whas && edpFsm_state_mkFSMstate == 4'd7 ;
  assign WILL_FIRE_RL_edpFsm_idle_l221c3_1 =
	     CAN_FIRE_RL_edpFsm_idle_l221c3_1 ;

  // rule RL_edpFsm_start_reg_1__dreg_update
  assign CAN_FIRE_RL_edpFsm_start_reg_1__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_edpFsm_start_reg_1__dreg_update = 1'd1 ;

  // rule RL_edpFsm_state_handle_abort
  assign CAN_FIRE_RL_edpFsm_state_handle_abort = 1'b0 ;
  assign WILL_FIRE_RL_edpFsm_state_handle_abort = 1'b0 ;

  // rule RL_edpFsm_state_every
  assign CAN_FIRE_RL_edpFsm_state_every = 1'd1 ;
  assign WILL_FIRE_RL_edpFsm_state_every = 1'd1 ;

  // rule RL_edpFsm_state_fired__dreg_update
  assign CAN_FIRE_RL_edpFsm_state_fired__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_edpFsm_state_fired__dreg_update = 1'd1 ;
  ...
  assign edpFsm_start_wire$whas =
	     WILL_FIRE_RL_edpFsm_fsm_start || WILL_FIRE_RL_edpFsm_restart ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_edpFsm_action_l222c14: edpFsm_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_edpFsm_action_l223c14: edpFsm_state_mkFSMstate$D_IN = 4'd2;
      WILL_FIRE_RL_edpFsm_action_l224c14: edpFsm_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_edpFsm_action_l225c14: edpFsm_state_mkFSMstate$D_IN = 4'd4;
      WILL_FIRE_RL_edpFsm_action_l227c16: edpFsm_state_mkFSMstate$D_IN = 4'd5;
      WILL_FIRE_RL_edpFsm_action_l229c16: edpFsm_state_mkFSMstate$D_IN = 4'd6;
      WILL_FIRE_RL_edpFsm_action_l230c16: edpFsm_state_mkFSMstate$D_IN = 4'd7;
  ...
  assign eeDmh$D_IN =
	     { dcpRespF$D_OUT[9:2],
	       ...
	       16'h0 } ;
  assign eeDmh$EN = CAN_FIRE_RL_ecp_egress ;

  // register eeMDst
  assign eeMDst$D_IN = eMAddrF$D_OUT ;
  assign eeMDst$EN = CAN_FIRE_RL_ecp_egress ;
  ...
  assign eePli$EN = CAN_FIRE_RL_ecp_egress ;

  // register isWrtResp
  assign isWrtResp$D_IN = dcpRespF$D_OUT[44:43] == 2'd1 ;
  assign isWrtResp$EN = CAN_FIRE_RL_ecp_egress ;
  ...
  // register ptr
  assign ptr$D_IN =
	     (x__h1849 == 4'd0) ? ((ptr == 4'd15) ? ptr : ptr + 4'd1) : 4'd0 ;
  assign ptr$EN = CAN_FIRE_RL_ecp_ingress ;
  ...
  assign dcpReqF$ENQ =
	     ...
	     (eDMH[13:12] == 2'd0 || eDMH[13:12] == 2'd1 ||
	      eDMH[13:12] == 2'd2) ;
  assign dcpReqF$DEQ = CAN_FIRE_RL_dcp_to_cp_request ;
  ...
  assign dcpRespF$ENQ =
	     ...
	     dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15_OR__ETC___d149 ||
	     WILL_FIRE_RL_cp_to_dcp_response ;
  assign dcpRespF$DEQ = CAN_FIRE_RL_ecp_egress ;
  assign dcpRespF$CLR = 1'b0 ;

  // submodule eMAddrF
  assign eMAddrF$D_IN = eMAddr ;
  assign eMAddrF$ENQ = CAN_FIRE_RL_rx_ecp_dcp ;
  assign eMAddrF$DEQ = CAN_FIRE_RL_ecp_egress ;
  ...
  assign ecpReqF$DEQ = CAN_FIRE_RL_ecp_ingress ;
  assign ecpReqF$CLR = 1'b0 ;

  // submodule ecpRespF
  always@(WILL_FIRE_RL_edpFsm_action_l222c14 or
	  ...
	  WILL_FIRE_RL_edpFsm_action_l230c16 or MUX_ecpRespF$enq_1__VAL_7)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_edpFsm_action_l222c14:
  ...
  // remaining internal signals
  assign IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15__ETC___d146 =
	     (dcpReqF$D_OUT[78:77] == 2'd0) ?
	       dcpRespF$FULL_N :
	       (dcpReqF$D_OUT[78:77] == 2'd1 ||
		!dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440 ||
		...
		dcpRespF$FULL_N) &&
	       IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17__ETC___d144 ;
  assign IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17__ETC___d144 =
	     (dcpReqF$D_OUT[78:77] == 2'd1) ?
	       dcpRespF$FULL_N &&
	       (dcpReqF_first__13_BITS_71_TO_64_31_EQ_IF_lastT_ETC___d438 &&
		lastTag[8] &&
		...
		cpReqF$FULL_N) :
	       ...
	       !dcpReqF$D_OUT[44] ||
	       cpReqF$FULL_N ;
  assign IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d450 =
	     dcpRespF$D_OUT[42] ? 8'h70 : 8'h30 ;
  assign bedw__h1824 =
	     { x__h5190, ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  assign dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440 =
	     dcpReqF$D_OUT[39:32] == lastTag[7:0] ;
  assign dcpReqF_first__13_BITS_71_TO_64_31_EQ_IF_lastT_ETC___d438 =
	     dcpReqF$D_OUT[71:64] == lastTag[7:0] ;
  assign dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15_OR__ETC___d149 =
	     dcpReqF$D_OUT[78:77] == 2'd0 || dcpReqF$D_OUT[78:77] == 2'd1 ||
	     dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440 &&
	     lastTag[8] &&
	     !dcpReqF$D_OUT[44] ;
  assign dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17_AND_ETC___d190 =
	     dcpReqF$D_OUT[78:77] == 2'd1 &&
	     (!dcpReqF_first__13_BITS_71_TO_64_31_EQ_IF_lastT_ETC___d438 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[76]) ||
	     ...
	     (!dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[44]) ;
  assign edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247 =
  ...
  assign x__h3330 = { bedw__h1824, 16'h0 } ;
  assign x__h5061 = { x__h5258, 32'h0 } ;
  assign x__h5102 = eDAddr | y__h5123 ;
  assign x__h5157 = eMAddr | y__h5168 ;
  assign x__h5190 = { ecpReqF$D_OUT[7:0], ecpReqF$D_OUT[17:10] } ;
  assign x__h5258 = { ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  assign y__h5123 = { 32'h0, x__h5190 } ;
  assign y__h5168 = { 16'd0, bedw__h1824 } ;
  ...
  always@(dcpRespF$D_OUT or
	  IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d450)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q10 =
